...
% spikes decreasing the loss as a function of one stimulus parameter at a time
...
test=2; % pick 1 or 2  from parameters below
nparam_all={'M','tau_s','sigma_s'};
...
parvec_all={1:1:50;5:2.5:50;0.25:0.25:5};
